...
export default function Hero() {
  ...
  return (
    <div className='text-center py-20  md:mt-10   flex flex-col justify-center items-center  '>
       <h1 className='md:text-5xl md:leading-tight xl:text-5xl 2xl:text-6xl md:py-6 text-3xl font-bold   leading-tight  w-5/6 md:w-3/4  hover:drop-shadow-3xl'> Discover New Opportunities  <br/> and Achieve Your <span
